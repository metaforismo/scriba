...
import { ScribaMode } from '@/app/generated/scriba_pb.js'
import { SCRIBA_MODE_SHORTCUT_DEFAULTS } from '../constants/keyboard-defaults.js'
    ...
    keyboardShortcuts: [
      {
        ...
        keys: SCRIBA_MODE_SHORTCUT_DEFAULTS[ScribaMode.TRANSCRIBE].map(
          normalizeLegacyKey,
        ) as KeyName[],
      ...
      {
        id: crypto.randomUUID(),
        keys: SCRIBA_MODE_SHORTCUT_DEFAULTS[ScribaMode.EDIT].map(
          normalizeLegacyKey,
        ) as KeyName[],
