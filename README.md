...
<div align="center">
  <img src="resources/build/icon.png" width="128" height="128" alt="Scriba Logo" />
  
  <h3>Smart dictation. Everywhere you want.</h3>
  
  <p>
    <strong>Scriba</strong> is an intelligent voice assistant that brings seamless voice dictation to any application on your computer. Simply hold down your trigger key, speak naturally, and watch your words appear instantly in any text field.
  </p>
...
1. **Download the latest release** from [heyito.ai](https://www.heyito.ai/) or the [GitHub releases page](https://github.com/heyito/scriba/releases)

2. **Install the application**:
   - **macOS**: Open the `.dmg` file and drag Scriba to Applications
...
> **Important**: Scriba requires a local transcription server for voice processing. See [server/README.md](server/README.md) for detailed server setup instructions.

```bash
# Clone the repository
git clone https://github.com/heyito/scriba.git
cd scriba
...
**Scriba** is built as a modern Electron application with a sophisticated multi-process architecture:
...
**Scriba** requires specific system permissions to function:
...
We welcome contributions! Whether you're fixing bugs, adding features, or improving documentation, your help makes **Scriba** better for everyone.
...
**Scriba** is built with and inspired by amazing open source projects:
...
- **Community**: [GitHub Discussions](https://github.com/heyito/scriba/discussions)
- **Issues**: [GitHub Issues](https://github.com/heyito/scriba/issues)
