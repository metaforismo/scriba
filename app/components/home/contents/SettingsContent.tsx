...
import SnippetsSettingsContent from './settings/SnippetsSettingsContent'
...
export default function SettingsContent() {
  ...
  const settingsMenuItems = [
    ...
    { id: 'snippets', label: 'Snippets', active: settingsPage === 'snippets' },
    {
      id: 'pricing-billing',
  ...
  const renderSettingsContent = () => {
    switch (settingsPage) {
      ...
      case 'snippets':
        return <SnippetsSettingsContent />
