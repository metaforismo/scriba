...
import { getScribaModeShortcutDefaults } from '@/lib/constants/keyboard-defaults'
...
export default function KeyboardTestContent() {
  ...
  const keyboardShortcut = getScribaModeShortcuts(ScribaMode.TRANSCRIBE)[0]
  const platform = usePlatform()
  const defaultKeys = getScribaModeShortcutDefaults(platform)[ScribaMode.TRANSCRIBE]
