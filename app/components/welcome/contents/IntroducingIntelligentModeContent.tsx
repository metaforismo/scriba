...
export default function IntroducingIntelligentMode() {
  ...
  const { getScribaModeShortcuts, updateKeyboardShortcut } = useSettingsStore()
  const keyboardShortcut = getScribaModeShortcuts(ScribaMode.EDIT)[0]
        ...
        <div className="flex flex-col h-full min-h-[400px] justify-between py-12">
          <div className="mt-8">
            ...
            <div className="text-2xl mb-1 font-medium">
              Introducing Scriba Intelligent Mode
            </div>
            <div className="mb-4 text-lg font-light">
              What you ask gets written.
            </div>
            {[
              'Press Hotkey -> Speak to Scriba',
              'Scriba send your speech to LLM',
            ...
            <Tip
              tipText="You can also trigger Intelligent Mode by saying 'Hey Scriba' when using the regular dictation hotkey."
              className="mt-3"
            />
          </div>
