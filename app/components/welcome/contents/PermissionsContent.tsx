          ...
          <div className="mt-8">
            ...
            <h1 className="text-3xl mb-4 mt-12 pr-24">
              {isAccessibilityEnabled && isMicrophoneEnabled
                ...
                : 'Set up Scriba on your computer'}
            </h1>
            <div className="flex flex-col gap-4 my-8 pr-24">
              <div className="border rounded-lg p-4 flex flex-col gap-2 bg-background border-border border-2">
                ...
                >
                  ...
                  <div className="font-medium text-base flex">
                    {isAccessibilityEnabled
                      ? 'Scriba can insert and edit text.'
                      : 'Allow Scriba to insert spoken words.'}
                  </div>
                </div>
                {!isAccessibilityEnabled && (
                  <>
                    <div className="text-sm text-muted-foreground mb-2">
                      This lets Scriba put your spoken words in the right textbox
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="right" align="start">
                            <p>
                              Scriba uses this to gather context based on the
              ...
              <div className="border rounded-lg p-4 flex flex-col gap-2 bg-background border-border border-2">
                ...
                >
                  ...
                  <div className="font-medium text-base flex">
                    {isMicrophoneEnabled
                      ? 'Scriba can use your microphone.'
                      : 'Allow Scriba to use your microphone.'}
                  </div>
                </div>
                {isAccessibilityEnabled && !isMicrophoneEnabled && (
                  <>
                    <div className="text-sm text-muted-foreground mb-2">
                      This lets Scriba hear your voice and transcribe your speech
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 mt-1">
                        <Button
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="right" align="start">
                            <p>
                              Scriba will show an animation when the mic is active{' '}
