            ...
            <div className="flex flex-col gap-4 my-8 pr-24">
              ...
              >
                <div className="flex items-center justify-between w-full mb-2">
                  <div className="font-medium">Help improve Scriba</div>
                  {shareAnalytics && (
                    <div>
                      <CheckCircle
                ...
                <div className="text-sm text-muted-foreground max-w-md mt-1">
                  To make Scriba better, this option lets us collect your audio,
                  transcript, and edits to evaluate, train and improve Scriba's
