...
interface SettingsState {
  ...
  createKeyboardShortcut: (mode: ScribaMode) => ShortcutResult
  removeKeyboardShortcut: (shortcutId: string) => void
  getScribaModeShortcuts: (mode: ScribaMode) => KeyboardShortcutConfig[]
...
const getInitialState = () => {
  ...
  return {
    ...
    showScribaBarAlways: storedSettings?.showScribaBarAlways ?? true,
    ...
    keyboardShortcuts: storedSettings?.keyboardShortcuts ?? [
      {
        keys: SCRIBA_MODE_SHORTCUT_DEFAULTS[ScribaMode.EDIT],
        mode: ScribaMode.EDIT,
        id: crypto.randomUUID(),
      },
      {
        keys: SCRIBA_MODE_SHORTCUT_DEFAULTS[ScribaMode.TRANSCRIBE],
...
export const useSettingsStore = create<SettingsState>(set => {
  ...
  return {
    ...
    setShowScribaBarAlways: createSetter('showScribaBarAlways', 'general'),
    ...
    getScribaModeShortcuts: (mode: ScribaMode) => {
