/**
 * Simple health check utility for the local Scriba server using the main process
 */
...
/**
 * Performs a health check against the local Scriba server via the main process
