const SCRIBA_ENV = (process.env.SCRIBA_ENV || 'prod').toLowerCase()
const DEEPLINK_SCHEME = SCRIBA_ENV === 'prod' ? 'scriba' : `scriba-dev`
...
<html lang="en">
  <head>
    ...
    <title>Authentication Successful - Scriba</title>
    <style>
      * {
        margin: 0;
        padding: 0;
  ...
  <body>
    <div>
      ...
      <button class="button" onclick="openApp()">Open Scriba</button>
    </div>
