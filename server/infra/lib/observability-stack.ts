...
export class ObservabilityStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: ObservabilityStackProps) {
    ...
    const alertTopic = new Topic(this, 'ScribaAlarmTopic', {
      topicName: `${stageName}-scriba-alarms`,
      displayName: `Scriba service alarms for ${stageName}`,
    })
    this.alertTopic = alertTopic

    const snsAction = new SnsAction(alertTopic)

    new Alarm(this, `${stageName}-HighScribaFargateCpu`, {
      ...
      actionsEnabled: true,
      alarmName: `${stageName}-scriba-cpu-high`,
    }).addAlarmAction(snsAction)

    new Alarm(this, `${stageName}-HighScribaFargateMemory`, {
      ...
      actionsEnabled: true,
      alarmName: `${stageName}-scriba-memory-high`,
    }).addAlarmAction(snsAction)

    new Alarm(this, `${stageName}-ScribaUnhealthyTasks`, {
      ...
      actionsEnabled: true,
      alarmName: `${stageName}-scriba-unhealthy-tasks`,
    }).addAlarmAction(snsAction)
